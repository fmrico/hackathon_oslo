...
def generate_launch_description():
    ...
    param_file = os.path.join(scenario_maps_dir, 'config', 'bombs_config_bookstore.yaml')
    rviz_file = os.path.join(scenario_maps_dir, 'config', 'config_bookstore.rviz')
    ...
    bombs_spawn_cmd = Node(
        package='scenario_maps',
        executable='bombs_spawn_bookstore',
        parameters=[
          param_file,
          {'use_sim_time': True}
        ],
