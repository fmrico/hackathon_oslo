...
def generate_launch_description():
    ...
    param_file = os.path.join(scenario_maps_dir, 'config', 'bombs_config_warehouse.yaml')
    rviz_file = os.path.join(scenario_maps_dir, 'config', 'config_warehouse.rviz')
    ...
    bombs_spawn_cmd = Node(
        package='scenario_maps',
        executable='bombs_spawn_warehouse',
        parameters=[
          param_file,
          {'use_sim_time': True}
        ],
