...
int main(int argc, char * argv[])
{
  ...
  std::vector<double> bomb_poses_x = {
    14.95, 12.1, 1.47, -3.22, -16.18, -12.46, -26.18, -30.26, -34.09, -34.11};
  std::vector<double> bomb_poses_y = {
    7.27, -11.36, 8.99, -11.19, 10.71, -11.25, -10.31, 7.74, -10.68, 10.50};
  ...
  std::mt19937 gen(rd());
  std::uniform_int_distribution<> choose_pos_distrib(0, 9);
